...
<body>
    <div class="container" style="max-width:900px;">
        <div class="card" id="o" style="margin-top: 10px">
            <div class="card-header">Phone Number OTP Authentication</div>
            <div class="card-body">
                ...
                <form>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <select class="form-control" id="countryCode" name="phone">
                        ...
                        <input type="text" id="number" class="form-control" placeholder="i.e: 2151234567">
                    </div>
